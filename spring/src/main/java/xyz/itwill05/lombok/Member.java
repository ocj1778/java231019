...
//3.콘솔에서 Jar 프로그램을 실행하여 Lombok 라이브러리를 이클립스(STS)에서 사용할 수 있도록 설정
...
//5.이클립스(STS)가 설치된 폴더로 이동하여 eclipse.ini(STS.ini) 파일을 편집하여 저장하고 이클립스(STS) 실행
...
//@Data : Setter 메소드, Getter 메소드, toString 메소드, equals 메소드, hashCode 메소드를 제공하기 위한 어노테이션 
