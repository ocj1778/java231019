...
public class ChatingServerApp {
	...
	public void sendMessage(String message) {
		...
		for(SocketThread client : clientList) {
			...
			// => 외부클래그의 메소드에서는 내부클래스로 생성된 객체를 사용하여 접근제한자에
	...
	// => 소켓을 이용하여 독립적인 입력 또는 출력 처리을 위해 새로운 스레드를 생성하여 입력
	//또는 출력 명령을 실행할 수 있도록 Thread 클래스를 상속받아 작성
