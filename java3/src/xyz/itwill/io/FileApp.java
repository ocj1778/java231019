...
public class FileApp {
	public static void main(String[] args) throws IOException {
		...
		//절대경로 표현방법 : 최상위 디렉토리를 기준으로 파일의 위치를 표현하는 방법
		//상대경로 표현방법 : 현재 실행 프로그램의 작업 디렉토리를 기준으로 파일의 위치를 표현
		//하는 방법 - 이클립스에는 프로그램이 작성된 프로젝트 폴더를 작업 디렉토리로 처리
		...
		//Windows 운영체제를 제외한 나머지 운영체제에서는 폴더와 파일을 구분하기 위해 / 기호 사용
		// => Windows 운영체제를 사용해도 Java 프로그램에서는 \ 기호 대신 / 기호 사용 가능 
		File fileTwo=new File("c:/data/itwill.txt");
		...
		//형식으로 작업 디렉토리에 존재하는 파일 또는 하위 디렉토리 표현
