...
//포괄적으로 표현한 이름
// => 콜렉션 클래스는 Collection 인터페이스 또는 Map 인터페이스를 상속받는 자식클래스
// => Collection 인터페이스는 Set 인터페이스와 List 인터페이스의 부모 인터페이스

//Set 인터페이스를 상속받은 콜렉션 클래스 - HashSet 클래스, TreeSet 클래스 등
// => 요소의 순서가 없으며 요소에 메모리 주소(HashCode)와 객체에 저장된 값(Value)이 같은 객체가  
...
public class SetApp {
	public static void main(String[] args) {
		...
		//요소(Element) : 콜렉션 객체에 제네릭 타입 대신 전달된 클래스의 객체를 저장하기 위한 메모리 영역
		set.add("홍길동");
		...
		System.out.println("set = "+set);//Set 객체의 요소는 저장 순서 미지정
		System.out.println("==============================================================");
		//Set 객체의 요소에는 메모리 주소(HashCode)와 필드값(Value)이 같은 동일한 객체 중복 저장 미허용
		set.add("홍길동");
		...
		// => 반복 지시자 : 내부의 커서(Cursor)를 사용하여 콜렉션 객체의 요소값을 제공하여 반복 처리
