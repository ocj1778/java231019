...
public class UserVOApp {
	public static void main(String[] args) {
		...
		//객체의 필드값이 같아도 객체가 다르므로 Set 객체의 요소값으로 저장 가능
		// => UserVO 클래스에 equals() 메소드와 hashCode() 메소드를 오버라이드 선언하면 Set 객체의  
		//add() 메소드 호출시 equals() 메소드와 hashCode() 메소드가 자동 호출되어 필드값과 메모리 
		//주소(HashCode)를 바교하여 동일한 객체가 Set 객체의 요소값으로 저장하지 않도록 처리
		set.add(new UserVO("abc123", "홍길동", "abc@itwill.xyz"));
