...
public class StringApp {
	public static void main(String[] args) {
		//문자열을 " " 기호를 사용하여 리터럴로 표현하면 JVM은 자동으로 메모리(MethodArea)에  
		//문자열이 저장된 String 객체 생성 - 상수객체 
		// => 메모리(MethodArea)에는 같은 값을 가진 상수객체 생성 불가능
		String str1="ABC";
		...
		//참조변수를 비교연산자로 비교하면 참조변수에 저장된 메모리 주소를 비교
		...
		System.out.println("===============================================================");
		//new 연산자로 String 클래스의 생성자를 호출하여 메모리(HeapArea)에 String 객체 생성
		...
		//전달받은 String 객체의 문자열이 크면 음수를 반환하고 같으면 0를 반환하는 메소드
		// => 비교 문자열이 영문자인 경우 대소문자를 구분하여 비교
