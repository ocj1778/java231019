...
//참조형으로 선언된 변수 : 특정 대상(객체)의 메모리 주소값을 저장하기 위한 변수 - 참조변수
// => 힙영역에 생성된 배열 또는 객체의 메모리 주소를 저장하여 메모리에 접근하기 위해 사용
// => 참조변수를 비교 연산자로 비교할 경우 참조변수에 저장된 메모리 주소 비교
// => 참조변수에 배열 또는 객체를 저장하지 않을 경우 초기값으로 null(아무것도 없을 표현하기 위한 키워드) 저장
...
public class ArrayApp {
	public static void main(String[] args) {
		...
		// => 참조변수와 배열의 요소를 구분하는 첨자를 사용하여 배열의 요소 참조
		...
		System.out.println("===============================================================");
		//참조변수.length : 참조변수로 참조되는 배열 요소의 갯수를 제공하기 위한 표현식 
		...
		// => 참조변수로 참조하는 배열의 요소값을 커서(Cursor)를 사용하요 차례대로 하나씩
