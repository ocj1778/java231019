...
<%
	...
	*/	
	...
	// => 클라이언트가 동일한 경우 모든 JSP 문서에서 session 객체에 저장된 속성값을 반환받아 사용 가능
	...
	// => session 내장객체에 속성값을 저장하여 리다이렉트 이동되는 JSP 문서에서 반환받아 사용 가능
	// => 리다이렉트 이동되는 JSP 문서에서는 session 객체에 저장된 속성값을 반환받은 후 제거
	...
	*/
	...
	// => request 내장객체에 속성값을 저장하여 포워드 이동되는 JSP 문서에서 반환받아 사용 가능
