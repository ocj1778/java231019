...
//패키지(Package) : 같은 목적의 자료형(참조형)을 명확하게 구분하여 그룹화 하기 위한 폴더
...
// => 도메인(Domain) : 인터넷상에서 개인 또는 그룹이 사용하는 컴퓨터를 표현하기 위해 제공되는 고유의 네트워크 식별자
// => ex) itwill.xyz - 도메인 >> xyz.itwill.app 

//Java 자료형이 선언될 Java 소스파일의 처음 위치에 Java 자료형이 선언된 패키지를 반드시 작성
//형식) package 패키지경로;
...
// => package 선언문 뒤, Java 자료형 선언 전에 작성
...
public class SubjectApp {
	public static void main(String[] args) {
		...
		//같은 이름의 자료형이 여러 개인 경우 패키지를 잘 구분하여 자료형 선택
